...
typedef struct memory_system_config memory_system_config;
...
CT_API allocator_i ct_create_allocator(allocator_i* parent_allocator, u64 size, memory_tag tag);

CT_API void* ct_allocate(u64 size, memory_tag tag);
CT_API void* ct_allocate_aligned(u64 size, u16 alignment, memory_tag tag);
CT_API void ct_free(void* ptr, memory_tag tag);

CT_API void* ct_reallocate(void* block, u64 old_size, u64 new_size, memory_tag tag);
CT_API void* ct_reallocate_aligned(void* block, u64 old_size, u64 new_size, u16 alignment, memory_tag tag);

CT_API void ct_set_memory(void* block, u8 value, u64 size);
...
// Type* ct_alloc_type(memory_tag tag)
// {
//     Type* result = (Type*)ct_allocate(sizeof(Type), tag);
// }

// template<typename Type>
// void ct_free_type(Type* ptr, memory_tag tag)
// {
//     ct_free((void*)ptr, tag);
// }

// template<typename Type>
// span<Type> ct_alloc_array(u64 count, memory_tag tag)
// {
...
// template<typename Type>
// void ct_free_array(span<Type>& array, memory_tag tag)
// {
...
// template<typename Type>
// Type* ct_clone_type(Type* src, memory_tag tag)
// {
...
// template<typename Type>
// span<Type> ct_clone_array(span<Type>& src, memory_tag tag)
// {
